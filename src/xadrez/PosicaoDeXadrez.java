...
public class PosicaoDeXadrez {
	...
	public PosicaoDeXadrez(char coluna, int linha) {
		if (coluna < 'a' || coluna > 'h' || linha < 1 || linha > 8) {
			throw new XadrezException("Erro ao instanciar PosicaoDeXadrez. " + "Os valores válidos são de a1 até h8");
		}
	...
	protected static PosicaoDeXadrez paraPosicaoDeXadrez(Posicao posicao) {
