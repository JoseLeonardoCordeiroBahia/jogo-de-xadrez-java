...
public class Torre extends PecaDeXadrez {
	...
	public boolean[][] movimentosPossiveis() {
		boolean[][] posicoesLivre = new boolean[getTabuleiro().getLinhas()][getTabuleiro().getColunas()];
		...
		while (getTabuleiro().posicaoExiste(posicaoAuxiliar) && !getTabuleiro().existePecaNaPosicao(posicaoAuxiliar)) {
			posicoesLivre[posicaoAuxiliar.getLinha()][posicaoAuxiliar.getColuna()] = true;
